...
import { BUTTON_TEXTS, PAGES, TOASTER_MESSAGES } from 'src/app/shared/utils/constant';
...
export class ResetPasswordComponent implements OnInit {
  ...
  resetPassword(): void {
    ...
    if (newPassword !== confirmPassword) {
      ...
      this.userService.resetPassword(newPassword, confirmPassword, this.userId).subscribe(response => {
        this.toasterService.showSuccess(TOASTER_MESSAGES.RESET_PASSWORD_SUCCESS);
